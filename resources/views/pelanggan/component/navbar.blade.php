...
<<<<<<< HEAD
>>>>>>> 74b14f5 (update)
<nav class="navbar navbar-dark navbar-expand-lg" style="background-color: #000c69">
                <div class="container">
                  <a class="navbar-brand" href="#">Bry HotWheels Shop</a>
                  ...
                  <div class="collapse navbar-collapse justify-content-end gap-4" id="navbarSupportedContent">
                    <ul class="navbar-nav gap-4">
                      ...
                      <li class="nav-item">
                        <a class="nav-link fs-5" {{Request::path() == 'shop' ? 'active' : '';}} href="/shop">Shop Now</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link fs-5" {{Request::path() == 'contact' ? 'active' : '';}} href="/contact">Support/Contact Us</a>
                      </li>
                    </ul>
...
=======
=======
<nav class="navbar navbar-dark navbar-expand-lg" style="background-color: #001eff">
    <div class="container">
        <a class="navbar-brand" href="#">Bry HotWheels Shop</a>
